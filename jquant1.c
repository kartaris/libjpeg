...
typedef struct {
  ...
  LJPEG9_JSAMPARRAY colorindex;	/* Precomputed mapping for speed */
...
create_colormap (LJPEG9_j_decompress_ptr cinfo)
{
  ...
  LJPEG9_JSAMPARRAY colormap;		/* Created colormap */
...
color_quantize (LJPEG9_j_decompress_ptr cinfo, LJPEG9_JSAMPARRAY input_buf,
		LJPEG9_JSAMPARRAY output_buf, int num_rows)
/* General case, no dithering */
{
  my_cquantize_ptr cquantize = (my_cquantize_ptr) cinfo->cquantize;
  LJPEG9_JSAMPARRAY colorindex = cquantize->colorindex;
...
LJPEG9_METHODDEF(void)
color_quantize3 (LJPEG9_j_decompress_ptr cinfo, LJPEG9_JSAMPARRAY input_buf,
		 LJPEG9_JSAMPARRAY output_buf, int num_rows)
...
LJPEG9_METHODDEF(void)
quantize_ord_dither (LJPEG9_j_decompress_ptr cinfo, LJPEG9_JSAMPARRAY input_buf,
		     LJPEG9_JSAMPARRAY output_buf, int num_rows)
...
LJPEG9_METHODDEF(void)
quantize3_ord_dither (LJPEG9_j_decompress_ptr cinfo, LJPEG9_JSAMPARRAY input_buf,
		      LJPEG9_JSAMPARRAY output_buf, int num_rows)
...
LJPEG9_METHODDEF(void)
quantize_fs_dither (LJPEG9_j_decompress_ptr cinfo, LJPEG9_JSAMPARRAY input_buf,
		    LJPEG9_JSAMPARRAY output_buf, int num_rows)
...
LJPEG9_METHODDEF(void)
start_pass_1_quant (LJPEG9_j_decompress_ptr cinfo, boolean is_pre_scan)
{
  my_cquantize_ptr cquantize = (my_cquantize_ptr) cinfo->cquantize;
  size_t arraysize;
  int i;
...
LJPEG9_METHODDEF(void)
finish_pass_1_quant (LJPEG9_j_decompress_ptr cinfo)
{
